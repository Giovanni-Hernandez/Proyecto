...
<body>
    ...
    <div class="jumbotron jumbotron-fluid rounded-0 img-jmbo text-center" style="margin-bottom:0">
        <div class="container"><br>
            <h1 id="Bienvenido"><i class="fas fa-user-graduate"></i> Buscar registro de alumno</h1>
    ...
    <div class="contact-box mt-3">
        <div class="container bg-dark p-6">
            ...
            <!--Formulario Buscar Registro-->
            <form action="/../Proyecto WEB/php/InfoAlumno.php" method="POST" onsubmit="return valCampo()" class="needs-validation" autocomplete="off" novalidate>
