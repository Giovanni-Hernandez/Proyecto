     ...
     <div class="container mt-4" id="menu">
        <div class="row align-items-center bg-dark">
            ...
            <div class="col-md-3 p-4 align-items-center">
                <p class="lead text-center font-weight-bold"><i class="fas fa-graduation-cap"></i> Contacto</p>
            </div>
                ...
                <tbody id="myTable">
                    ...
                    foreach($result as $row){?>
                        <tr class="text-center">
                            ...
                            <td class="align-middle"><?php echo $row['CalleYNumero']; ?></td>
                            <td class="align-middle"><?php echo $row['Colonia']; ?></td>
                            <td class="align-middle"><?php echo $row['CodigoPostal']; ?></td>
                            <td class="align-middle"><?php echo $row['TelefonoOCelular']; ?></td>
