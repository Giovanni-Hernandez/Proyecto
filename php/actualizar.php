...
<body>
    ...
    <div class="jumbotron jumbotron-fluid rounded-0 img-jmbo text-center" style="margin-bottom:0">
        <div class="container"><br>
            <h1 id="Bienvenido"><i class="fas fa-pen-alt"></i> Actualizar registro de alumno</h1>
            <p>Por favor, ingrese el número de boleta del estudiante</p>
    ...
    <div class="contact-box mt-3">
        <div class="container bg-dark p-6">
            ...
            <form action="/../Proyecto WEB/php/ActualizarRegistro.php" method="POST" onsubmit="return valCampo()" class="needs-validation" autocomplete="off" novalidate>
                <div class="form-group">
                    <label for="txtnumero">No. de boleta<span class="text-danger">*</span></label>
                    <input type="text" class="form-control" maxlength="10" id="txtnumero" name="txtnumero" required onkeypress="return valiBoleta(event)" style="text-transform: uppercase;" onchange="numBoleta()" autocomplete="off">
                </div>
                <div class="row">
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <a href="/../Proyecto WEB/php/CerrarSesion.php" class="btn btn-outline-danger btn-block btn-lg mt-3" role="button">Cerar sesión <i class="fas fa-window-close"></i></a>
                    </div>
                </div>
            </form>
